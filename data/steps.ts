...
export const steps: NarutoStep[] = [
  ...
  },
  {
    ...
    episodeGuide: [
      {
        label: "Optional filler episode. Worth watching as a bonus stop.",
        episodes: "101",
        type: "filler",
      },
    ],
  ...
  {
    slug: "pre-sasuke-filler-block",
    title: "Pre-Sasuke Filler Block",
    episodes: "102–106",
    canonType: "filler",
    instruction: "Skip",
    skip: "102–106",
    optionalLater: "Optional later",
    note: "Short filler stretch before the next main arc.",
    overview:
      "The anime pauses the main path here before moving into the next major story arc.",
    whyItMatters:
      "Skipping this keeps the momentum clean before Sasuke Recovery Mission.",
    prompt: "Would you ever come back to short filler blocks like this?",
    watchNotes: "Skip all.",
    episodeGuide: [
      {
  ...
  },
  {
    ...
    watchNotes:
      "Everything from 107 onward is main-path material, with mixed-canon bridges you should still watch.",
    episodeGuide: [
      {
  ...
  },
  {
    ...
    overview: "The anime pauses the main story here.",
  ...
  {
    slug: "sakura-determination-mixed",
    ...
    overview:
      "A short mixed-canon bridge inside late Part 1 that stays in the required path.",
    whyItMatters:
      "Mixed canon belongs in the main program, even when it sits between filler stretches.",
    prompt: "Did this short bridge feel worth keeping in the main path?",
    watchNotes: "Watch both episodes.",
    episodeGuide: [
      {
        label: "Mixed-canon bridge. Must watch.",
        episodes: "141–142",
        type: "mixedCanon",
      },
    ],
  },
  {
    ...
    optionalLater: "Optional later",
    note: "Full filler stretch.",
    overview: "The anime stalls the story completely here.",
    whyItMatters: "Skipping preserves pacing before the Part 1 finale.",
    prompt: "Would you ever come back to this after finishing the main story?",
    watchNotes: "Skip all.",
    episodeGuide: [
      {
        label: "Full filler block. Skip all of it.",
